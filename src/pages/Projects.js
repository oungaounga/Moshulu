      ...
      <div className=" pb-[0.3rem]">
        <div className="flex flex-col justify-between">
          <div className="flex justify-between">
            ...
            <div>
              <a
                href="https://github.com/oungaounga/firebase-test"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
                  ...
                  height="1.5rem"
                  fill="currentColor"
                  class="bi bi-github inline m-1 hover:fill-blue-500"
                  viewBox="0 0 16 16"
                >
              ...
              >
                <svg
                  ...
                  height="1.2rem"
                  fill="currentColor"
                  class="bi bi-arrow-up-right inline m-1  hover:fill-blue-500"
                  viewBox="0 0 16 16"
                >
                  <path
                    fill-rule="evenodd"
        ...
        <div className="appear">
          ...
          <div>
            ...
            <div className="flex flex-col mt-[2rem] gap-6 divide-y-[1px] divide-neutral-600">
              {/* <div className=" pb-[0.3rem]">
                ...
                <div className="md:text-base flex flex-col gap-2 ml-[0.5rem] mr-[0.5rem] ">
                  <p className="text-justify">
                    ...
                    is an association started by my friend Quentin Fontana,
                    aiming to help international students on a year abroad in
                    Montpellier. It needs a platform to manage students and to
                    develop a network. I'm currently building the website, which
                    presents the association and its main activity, organizing
                    events. Users can create a profile and join events.
                  </p>
                  <p>React, Firebase, Tailwind, NextUI</p>
                </div>
              </div>
              <div className="pb-[0.3rem]">
                <div className="flex flex-col">
                  <div className="flex justify-between">
                    ...
                    <div>
                      <a
                        href="https://github.com/oungaounga/tetris-vanille-project"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <svg
                  ...
                  <span className="text-sm text-neutral-500">17/01/2023</span>
                </div>
                <div className="md:text-base flex flex-col">
                  <p className="ml-[0.5rem] mr-[0.5rem] text-justify">
              ...
              <div className=" pb-[0.3rem]">
                <div className="flex flex-col">
                  <div className="flex justify-between">
                    ...
                    <div>
                      <a
                        href="https://github.com/oungaounga/project21808112.github.io"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <svg
                      ...
                      <a
                        href="https://oungaounga.github.io/project21808112.github.io/"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <svg
                ...
                <div className="md:text-base flex flex-col">
                  <p className="ml-[0.5rem] mr-[0.5rem] text-justify">
                    First website I have built. The class assignement was to
                    build and deploy a website so that the teacher can visit and
                    download homeworks. The homeworks is the interesting parts,
                    many projects to use optimisation concepts in study cases
                    using Python
                  </p>
                  <div className="ml-2 mt-2">
                    <p> Python, HTML, CSS</p>
              ...
              {/* <MakeProjectItem item={projectsAng[0]} /> */}
